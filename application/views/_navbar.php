          ...
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li id='nav_viewlist'><a href="<?=site_url("/viewlist/table")?>">Total View List</a></li>
				        <li id='nav_issuelist'><a href="<?=site_url("/issue/issuelist")?>">Total Issues List</a></li>
                <li id='nav_edit'><a href="<?=site_url("user/edit")?>">Edit profile</a></li> 
